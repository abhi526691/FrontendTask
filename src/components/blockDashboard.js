...
export default class BlockDashboard extends Component {
    ...
    onSelectBlock = block => {
        if (this.state.selectedYear !== "") {
            ...
            this.setState({
                selectedBlock: block,
                urlGrade: `${baseURL}/public/dashboard/5ea14558-25d6-4a91-af30-6b475079cc5d?block=${block}&district=${this.state.selectedDistrict}`,
    ...
    componentDidMount() {
        ...
        dispatchCustomEvent({type: 'titleChange', data: {title: 'Block Level Dashboard'}});
    }
