...
export default class DownloadReportDashboard extends Component {
    ...
    onSelectBlock = block => {
        if (this.state.selectedYear !== "") {
            ...
            this.setState({
                selectedBlock: block,
                urlGrade: `${baseURL}/question/0ee2a162-b8fe-48aa-ae8a-6b7ed0bf6ab7?block=${block}&district=${this.state.selectedDistrict}`,
                urlLO: `${baseURL}/question/0ee2a162-b8fe-48aa-ae8a-6b7ed0bf6ab7?block=${block}&district=${this.state.selectedDistrict}`
            });
        }
    };
